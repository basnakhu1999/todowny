...
const feelings = [
    { emoji: '☺️', text: 'สิ่งเล็กๆ..ที่ตั้งใจทำให้วันธรรมดาดูน่ารักขึ้น' },
    { emoji: '✨', text: 'แค่เห็นแล้วนึกถึงเลยอยากให้ยิ้มบ้างในวันนี้14Feb' },
    { emoji: '🥲', text: 'ไม่ได้มีอะไรพิเศษ..แต่อยากให้วันนี้สดใสขึ้น' },
    { emoji: '💗', text: 'ข้อนี้คิดไม่ออกจริงๆ..555' },
    { emoji: '🙏💗', text: 'ขอบคุณทุกๆกำลังใจ..ที่ทำให้การมีพี่อยู่ตรงนี้เป็นเรื่องน่ารักเสมอ' }
];
...
const photos = [
    {
        url: 'https://raw.githubusercontent.com/basnakhu1999/todowny/refs/heads/main/gift1.png', // ใส่ URL รูปที่ 1
        caption: '...😊'
    },
    {
        url: 'https://raw.githubusercontent.com/basnakhu1999/todowny/refs/heads/main/gift2.jpg', // ใส่ URL รูปที่ 2
        caption: 'นึกถึงเลยอยากให้ยิ้มบ้าง..'
    },
    {
        url: 'https://raw.githubusercontent.com/basnakhu1999/todowny/refs/heads/main/gift3.jpg', // ใส่ URL รูปที่ 3
        caption: 'แฮะๆ มันคือดอกไม้จริงๆนะ'
    },
    {
        url: 'https://raw.githubusercontent.com/basnakhu1999/todowny/refs/heads/main/gift4.jpg', // ใส่ URL รูปที่ 4
        caption: 'เด็กอยากเอาให้จริงๆ ^^'
    }
];
...
const postcardMessages = [
    ...
    { id: 'messageLine1', text: 'ขอบคุณทุกช่วงเวลาที่ทำให้วันธรรมดา', type: 'typewriter' },
    { id: 'messageLine2', text: 'ไม่ธรรมดา ได้คุย ได้หัวเราะ ได้หายเหนื่อย ', type: 'typewriter' },
    { id: 'messageLine3', text: 'ไม่แน่ใจว่าตั้งแต่ตอนไหน', type: 'typewriter' },
    { id: 'messageLine4', text: 'แต่การมีพี่อยู่มันดีจริงๆ', type: 'typewriter' },
...
const myMessages = [
    "เด็กจะเป็นเด็กดีของพี่ต่อไป ",
    "ขอบคุณที่เล่นจนจบน้าาา ",
    "อนาคตเป็นยังไงไม่รู้ แต่ที่รู้ๆเด็กคนนี้ตั้งใจทำมากๆ ส่งใจปิ้วๆ💗💗"
...
async function showFinalExchange() {
    ...
    herMessage.innerHTML = `<span class="bubble-text loading-dots">💗 กำลังพิมพ์<span class="dots"></span></span>`;
    ...
    try {
        ...
        if (data.success && data.message) {
            ...
            herMessage.innerHTML = `<span class="bubble-text">ยังไม่ได้ฝากข้อความอะไรไว้นะ</span>`;
        }

    } catch (error) {
        console.log('Fetch error:', error);
        await delay(800);
        herMessage.innerHTML = `<span class="bubble-text">${userSentMessage || 'ยังไม่ได้ฝากข้อความอะไรไว้นะ'}</span>`;
    }
